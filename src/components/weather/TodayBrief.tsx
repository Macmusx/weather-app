        ...
        <>
            <div className='flex justify-evenly items-center'>
                <div className='min-w-[8rem]'>
                    ...
                    <div className="font-bold text-center text-2xl mb-2">{currentForecast.feelslike}</div>
                </div>
                ...
                <div className='mt-4 ml-3 mr-3'>
                    <div className="font-bold text-2xl text-center">{currentForecast.wind}</div>
                    <div className="text-center">Wind Speed</div>
                    <div className="font-bold text-2xl text-center">{currentForecast.pressure}</div>
                    <div className="text-center">Pressure</div>
                    <div className="font-bold text-2xl text-center">{currentForecast.visibility}</div>
                    <div className="text-center">Visibility</div>
                    <div className="font-bold text-2xl text-center">{currentForecast.precipitation}</div>
